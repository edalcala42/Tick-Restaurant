		...
		<div class="gtco-container">
			<div class="row">
				<div class="col-md-8 col-md-offset-2 text-center gtco-heading animate-box">
					<h2 class="cursive-font">¡Gracias por su espera!</h2>
					<p>En breve uno de nuestros encargados irá personalmente a su mesa para asisistirlo.</p>
					<img src="images/hero_depressed.jpg" alt="hero" class="img_empleado">
				</div>
			</div>
		</div>
	</div>
