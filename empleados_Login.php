...
<php>
	...
	<title>Tick-Restaurant &mdash; Empleados</title>
		...
		<div class="gtco-container">
			...
			<div class="row">
				<div class="col-sm-4 col-xs-12">
					<div id="gtco-logo"><a href="index.php">Tick-Restaurant<em>.</em></a></div>
				</div>
				<div class="col-xs-8 text-right menu-1">
					<ul>
						...
						<li class="btn-cta"><a href="index.php?#"><span>Cliente</span></a></li>
					</ul>	
				</div>
			</div>
				...
				<div class="col-md-12 col-md-offset-0 text-left">
					<div class="row row-mt-15em">
						<div class="col-md-7 mt-text animate-box" data-animate-effect="fadeInUp">
							<span class="intro-text-small">Tick-Restaurant</span>
							<h1 class="cursive-font">Delicious Food is an art!</h1>	
						</div>
								...
								<div class="tab">
									<div class="tab-content">
										<div class="tab-content-inner active" data-content="signup">
											<h3 class="cursive-font">Empleado</h3>
											<form action="#">
