...
<php>
	...
	<title>Tick-Restaurant &mdash; Pedido</title>
			...
			<div class="row">
				...
				<div class="col-xs-8 text-right menu-1">
					<ul>
						...
						<li class="has-dropdown active"><a href="http://localhost/Billing_Cafe_System/billing/index.php">Ver Pedido</a></li>
		...
		<div class="gtco-container">
			<div class="row">
				<div class="col-md-8 col-md-offset-2 text-center gtco-heading animate-box">
					<h2 class="cursive-font">¡AVISO!</h2><br>
					<h3 class="cursive-font">Orden CANCELADA correctamente.</h3>
					<img src="images/tired_spongebob.jpg" alt="internet_kid" class="memes"><br>
					<p>Si así lo desea, puede seguir ordenando por medio del menú.</p>
