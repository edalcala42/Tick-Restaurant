...
<php>
	...
	<title>Tick-Restaurant &mdash; Orden Recibida</title>
		...
		<div class="gtco-container">
			<div class="row">
				<div class="col-md-8 col-md-offset-2 text-center gtco-heading animate-box">
					<h2 class="cursive-font">¡Orden recibida!</h2>
					<p>Pronto recibirá la comida solicitada en su mesa.<br>
						Si así lo desea, puede seguir ordenando por medio del menú.</p><br>
					<img src="images/internet_kid.gif" alt="internet_kid">
					<br>
					</a>
