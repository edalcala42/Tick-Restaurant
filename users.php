		...
		<div class="card ">
			...
			<thead>
				<tr>
					...
					<th class="text-center">Telefono cel.</th>
					<th class="text-center">Telefono emerg.</th>
			...
			<tbody>
				<?php
 					...
 					$type = array("","Admin","Mesero","Jefe de meseros");
				 ...
				 <tr>
				 	...
				 	<td>
                    	<?php echo $row['Telefono del contacto']; ?>
                    </td>
                    <td>
                    	<?php echo $row['Telefono de emergencias']; ?>
                    </td>
                    <td>
                        <?php echo $row['Fecha de ingreso'];?>
                    </td>
                    <td>
                        <?php echo $row['Domicilio']; ?>
                    </td>
                    <td>
                        <?php echo $row['Codigo postal']; ?>
                    </td>
                    <td>
                        <?php echo $row['Estado']; ?>
                    </td>
