			...
			<div class="row">
				...
				<div class="col-xs-8 text-right menu-1">
					<ul>
						...
						<li class="active"><a href="pedido.php">Ver Pedido</a></li>
						...
						<div class = "content_pedidos">
						 ...
						 <a href="menu.php">
							 <button class="boton_confirmar">
								<a href="orden-confirmada.php"> Confirmar Orden</a>
							 </button>
						 </a>
							 <button class="boton_cancelar">
								<a href="orden-cancelada.php">Cancelar Orden</a>
							 </button>
						 </a>
					</form>		
				</div>
		...
		<div class="gtco-container">
			<div class="row row-pb-md">
				...
				<div class="col-md-12 text-center copyright">
					<p><small class="block">&copy; 2016 Free php5. All Rights Reserved.</small> 
